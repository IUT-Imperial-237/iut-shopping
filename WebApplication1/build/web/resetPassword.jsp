<%-- 
    ...
    Created on : Sep 19, 2019, 3:32:11 AM
...
<html>
    <head>
        ...
        <title>Reset Password | IUT Commerce</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div data-form-type="formoid">
                            <!---FormBuilder Form--->
                            <form action="ResetPasswordServlet" method="POST" class="mbr-form form-with-styler" data-form-title="Login Form">
